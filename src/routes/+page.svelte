<script lang="ts">
	...
	const programMedia = [
		{
			illustration: `${base}/images/support-settle-color.png`,
		},
		{
			illustration: `${base}/images/support-explore-color.png`,
		},
		{
			illustration: `${base}/images/support-community-color.png`,
		},
		{
			illustration: `${base}/images/support-learn-color.png`
		}
	];
